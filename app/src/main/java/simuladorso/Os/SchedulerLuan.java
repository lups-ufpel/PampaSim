...
public class SchedulerLuan extends Scheduler {
    public SchedulerLuan(List<Process> newList, List<Process> readyList, List<Process> waitingList, List<Process> terminatedList, int numCores) {
        super(newList, readyList, waitingList, terminatedList, numCores);
    }
